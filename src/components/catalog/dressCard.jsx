...
const DressCard = memo(({ dressData }) => {
   ...
   return (
      <div className="relative w-full max-w-[200px] shrink-0 cursor-pointer hover:scale-105 hover:z-20 transition-transform duration-300">
         <div
            onClick={onRedirect}
         ...
         <div
            ...
            className="bg-primary hover:scale-110  size-12 rounded-full grid place-items-center absolute top-0 start-0 -translate-x-1/3 -translate-y-1/3 transition-transform duration-150 active:scale-110"
         >
